...
(function() { this.JST || (this.JST = {}); this.JST["templates/comments/index_comment"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('');  if (CurrentUser.get('id') == get('user_id')) { ; __p.push('\n    <div class=\'delete_comment\'>delete</div>\n');  } ; __p.push('\n\n<div class=\'comment_container\'>\n    <img class=\'avatar\' src="',(''+ get('thumb_url') ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),'">\n    \n    <div class=\'content_container\'>\n\n        <a class=\'user_name\'>',(''+ get('first_name') ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),' ',(''+ get('last_name') ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),'</a>\n\n        <span class=\'comment_body\'>',(''+ get('body') ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),'</span>\n\n    </div>\n    <div class=\'date\'>',(''+ get('formatted_time') ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),'</div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["templates/comments/index_comment_form"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<form id=\'comment_form\'>\n    <input id=\'comment_input\' class=\'text_input\' type=\'text\' maxlength=\'255\' placeholder=\'Share your thoughts...\'>\n    <button class=\'btn text\' type=\'submit\' value=\'submit\'>Share</button>\n    <br class=\'clear\'>\n</form>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["templates/endorsements/index_endorsement_list_container"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="endorsements_container">\n    <ol class=\'endorsements establishments_list\'>\n        <p>',(''+ get('first_name') ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),' isn\'t endorsing anything yet.</p>\n    </ol>\n    <div class=\'pagination_container\'></div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["templates/establishments/index_establishment"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="establishment_info">\n    <a class=\'biz_name\'>',(''+ get('name') ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),'</a>\n\n    <p class="details">',(''+ get('street_number') ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),' ',(''+ get('street') ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),'</p>\n\n    <p class="details phone">',(''+ get('phone') ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),'</p>\n\n    ');  if (get('website')) { ; __p.push('\n        <a class="details website" href="',(''+ get('website') ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),'" target=\'_blank\'>',(''+ get('website') ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),'</a>\n    ');  } ; __p.push('\n\n    <p class=\'details small\'>\n        ',  get('price_symbol') ? get('price_symbol') : '' ,'\n    </p>\n</div>\n\n<div class=\'endorse_btn_container\'></div>\n<br class=\'clear\'>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["templates/establishments/no_results"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<li id=\'no_results_message\'>\n    <h1>Bummer! No results found.</h1>\n    <p>Why not give one of these links a try.</p>\n\n    <div id=\'other_search_links_container\'>\n        <a href=\'/users/search\' class=\'nav\'>Find Friends</a>\n        <a href=\'/establishments/search\' class=\'nav\'>Endorse a Restaurant</a>    \n    </div>\n</li>\n');}return __p.join('');};
}).call(this);
...
(function() { this.JST || (this.JST = {}); this.JST["templates/establishments/search_suggestion_list"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<ul id=\'find_establishment_results\' class=\'users_list card border grey\'></ul>\n');}return __p.join('');};
}).call(this);
...
(function() { this.JST || (this.JST = {}); this.JST["templates/establishments/show_establishment_info"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class=\'establishment_info left_column\'>\n    <p class=\'biz_name\'>',(''+ get('name') ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),'</p>\n\n    <p class="details">',(''+ get('street_number') ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),' ',(''+ get('street') ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),'</p>\n\n    <p class="details phone">',(''+ get('phone') ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),'</p>\n\n    ');  if (get('website')) { ; __p.push('\n        <a class="details website" href="',(''+ get('website') ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),'" target=\'_blank\'>',(''+ get('website') ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),'</a>\n    ');  } ; __p.push('\n\n    <p class=\'details small\'>\n        ',  get('price_symbol') ? get('price_symbol') : '' ,'\n    </p>\n    <div class=\'endorse_btn_container\'></div>\n</div>\n\n<div class=\'right_column\'>\n    <div id=\'establishment_photos_container\'></div>\n</div>\n\n<br class=\'clear\'>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["templates/establishments/show_establishment_info_photo"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div id=\'photos_preview_container\'></div>\n<div id=\'photos_upload_forms_container\'></div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["templates/followed_users/index_followed_users_list"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="followed_users_container">\n    <ul class=\'followed_users users_list\'>\n        <p>',(''+ get('first_name') ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),' isn\'t following anyone yet.</p>\n    </ul>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["templates/followers/index_followers_list"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="followers_container">\n    <ul class=\'followers users_list\'>\n        <p>No one is following ',(''+ get('first_name') ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),' yet.</p>\n    </ul>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["templates/main/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div id=\'main_index_establishments_container\'>\n    <div id=\'main_filter_container\'></div>\n\n    <div id=\'establishments_list_container\' class=\'card border\'>\n        <ol class=\'establishments_list\'></ol>\n        <div class=\'pagination_container\'></div>\n    </div>\n\n    <div class=\'map_canvas_container\'></div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["templates/photos/gallery"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div id=\'flexslider_container\'>\n    <div class=\'flexslider\'></div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["templates/photos/media_viewer"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<ul class=\'slides\'></ul>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["templates/photos/media_viewer_photo"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<img src="',(''+ get('medium_url') ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),'">\n<div class=\'flex-caption\'>\n    <a class=\'user_name\'>',(''+ get('username') ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),'</a>\n\n    ');  if (get('caption')) { ; __p.push('\n        <p class=\'caption\'>',(''+ get('caption') ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),'</p>\n    ');  } ; __p.push('\n\n    <p class=\'date\'>',(''+ get('formatted_time') ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),'</p>\n</div>\n<br class=\'clear\'>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["templates/photos/no_results"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<p id=\'no_results_message\' class=\'card\'>',(''+ get('name') ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),' doesn\'t have any photos, yet!</p>\n');}return __p.join('');};
}).call(this);
...
(function() { this.JST || (this.JST = {}); this.JST["templates/photos/photo_upload_forms"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div id=\'upload_image_form_container\'></div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["templates/photos/photo_upload_image_form"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div id=\'photo_upload_form_container\'>\n    <label>Add Photos<button><img alt="Camera icon" src="/assets/camera_icon.svg" /></button></label>\n\n    ');  if (CurrentUser.get('id')) { ; __p.push('\n        <form id=\'photo_upload_form\' method="post" enctype="multipart/form-data" action=\'/api/users/photo\'>\n            <input name="authenticity_token" value="',(''+ $('meta[name="csrf-token"]')[0].content ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),'" type="hidden">\n            <input name="establishment_id" value="',(''+ get('id') ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),'" type="hidden">\n            <input type=\'file\' name=\'image\' capture=\'camera\'>\n        </form>\n\n        <div id=\'upload_caption_form_container\'></div>\n    ');  } ; __p.push('\n</div>\n');}return __p.join('');};
}).call(this);
...
(function() { this.JST || (this.JST = {}); this.JST["templates/users/index_user"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<p class=\'user_name\'>',(''+ get('first_name') ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),' ',(''+ get('last_name') ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),'</p>\n<div class=\'follow_btn_container\'></div>\n<br class=\'clear\'>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["templates/users/search"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div id=\'search_wrapper\'>\n    <div id=\'find_user_container\' class=\'search_container card border\'>\n        <h3>Search for Friends</h3>\n\n        <form id=\'user_search_form\'>\n\n            <div class=\'field\'>\n                <label for=\'email\'>Email:</label><br>\n                <input id=\'email\' type=\'text\' autocomplete=\'off\' placeholder=\'bob.smith@example.com\' autofocus class=\'text_input\'>\n            </div>\n\n            <div class=\'field\'>\n                <label for=\'first_name\'>First Name:</label><br>\n                <input id=\'first_name\' type=\'text\' autocomplete=\'off\' placeholder=\'First Name\' class=\'text_input\'>\n            </div>\n\n            <div class=\'field\'>\n                <label for=\'last_name\'>Last Name:</label><br>\n                <input id=\'last_name\' type=\'text\' autocomplete=\'off\' placeholder=\'Last Name\' class=\'text_input\'>\n            </div>\n\n            <div class=\'center\'>\n                <input class=\'btn text\' type=\'submit\' value=\'Submit\'>\n            </div>\n        </form>\n    </div>\n        \n    <div id=\'find_user_results_container\'></div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["templates/users/search_suggestion_list"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<ul id=\'find_user_results\' class=\'users_list card border grey\'></ul>\n');}return __p.join('');};
}).call(this);
...
(function() { this.JST || (this.JST = {}); this.JST["templates/users/show_following_container"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="card" id=\'follow_tabs_container\'>\n    <div id=\'endorsements_tab\' class=" tab current_tab">Endorsements: ',(''+ get('num_endorsements') ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),'</div>\n    <div id=\'followers_tab\' class="tab">Followers: ',(''+ get('num_followers') ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),'</div>\n    <div id=\'followed_users_tab\' class="tab">Following: ',(''+ get('num_followed_users') ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),'</div>\n    <br class=\'clear\'>\n</div>\n\n<div class="following_list_container card"></div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["templates/users/show_user"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div id=\'profile_container\' class=\'card border\'>\n    <div class=\'photo_container\'>\n        <img src="',(''+ get('avatar_url_medium') ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),'" >\n    </div>\n\n    <h1 class=\'user_name\'>',(''+ get('first_name') ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),' ',(''+ get('last_name') ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),'</h1>\n\n    <div class=\'follow_btn_container\'>\n        <a href=\'/users/edit\' class=\'edit btn text\'>Edit Profile</a>\n    </div>\n</div>\n');}return __p.join('');};
}).call(this);
AuthenticationOptionsView = Backbone.View.extend({
    ...
    hideModal: function () {
        $('#login_modal_container').fadeOut('200');
    }
});
