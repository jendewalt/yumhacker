...
(function() { this.JST || (this.JST = {}); this.JST["templates/application/filter"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div id=\'filter_container\'>\n    <div id=\'radius_container\'>\n        <label>Distance: </label>\n        <select id=\'radius_select\'>\n            <option class=\'radius_opt\' value=\'0.1\' ',  Filter.get('radius') == '0.1' ? 'selected' : '' ,'>4 Blocks</option>\n            <option class=\'radius_opt\' value=\'1\' ',  Filter.get('radius') == '1' ? 'selected' : '' ,'>1 Mile</option>\n            <option class=\'radius_opt\' value=\'5\' ',  Filter.get('radius') == '5' ? 'selected' : '' ,'>5 Miles</option>\n            <option class=\'radius_opt\' value=\'10\' ',  Filter.get('radius') == '10' ? 'selected' : '' ,'>10 Miles</option>\n            <option class=\'radius_opt\' value=\'20\' ',  Filter.get('radius') == '20' ? 'selected' : '' ,'>20 Miles</option>\n        </select>\n    </div>\n\n    ');  if (CurrentUser.logged_in()) { ; __p.push('\n        <div id=\'from_followed_container\'>\n            <input id=\'from_followed\' type=\'checkbox\' ',  Filter.get('from_followed') ? 'checked' : '' ,' >\n            <label class=\'small\' for=\'from_followed\'>Show only people I\'m following</label>\n        </div>\n    ');  } ; __p.push('\n</div>\n');}return __p.join('');};
}).call(this);
...
(function() { this.JST || (this.JST = {}); this.JST["templates/establishments/index_establishment"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<a class=\'biz_name\'>',  get('name') ,'</a>\n<p class="details">',  get('street_number') ,' ',  get('street') ,'</p>\n\n<p class="details phone">',  get('phone') ,'</p>\n<a class="details website" href="',  get('website') ,'" target=\'_blank\'>',  get('website') ,'</a>\n\n<p class="details price">\n');  for (var i = 0; i < get('price'); i++) { ; __p.push('$');  } ; __p.push('\n</p>\n');}return __p.join('');};
}).call(this);
...
(function() { this.JST || (this.JST = {}); this.JST["templates/users/index_user"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<p class=\'user_name\'>',  get('name') ,'</p>\n<div class=\'follow_btn_container\'></div>\n<br class=\'clear\'>\n');}return __p.join('');};
}).call(this);
