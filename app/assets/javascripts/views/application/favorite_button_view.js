ApplicationFavoriteButtonView = Backbone.View.extend({
    ...
    initialize: function (options) {
        ...
        this.model.set({ 'list_id': options.list.get('id'), 'user_favoriting': options.list.get('user_favoriting'), 'number_favorites': options.list.get('number_favorites') }, { silent: true });
        this.render();
    },
